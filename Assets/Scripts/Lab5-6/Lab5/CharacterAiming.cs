...
public class CharacterAiming : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        //Hack to get your lab doc gif camera implementation
        if (movement.input.x !=0 | movement.input.y != 0) transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(0, yawCamera, 0), turnSpeed * Time.fixedDeltaTime);
    }
}
